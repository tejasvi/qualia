...
from qualia.models import View, NodeId, Cursors, LastSync, Tree
...
def sync_buffer(buffer_lines: list[str], main_id: NodeId, last_sync: LastSync, cursors: Cursors,
                transposed: bool, realtime_session: Realtime, git_sync_event: Event) -> View:
    if main_id in last_sync:
        main_view, changes = Process().process_lines(buffer_lines, main_id, last_sync, cursors)
